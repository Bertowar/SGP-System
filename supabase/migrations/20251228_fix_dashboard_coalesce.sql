-- MIGRATION: 20251228_fix_dashboard_coalesce.sql
-- DESCRIPTION: Fixes 'COALESCE types text and integer cannot be matched' by casting IDs to text.
...
END IF;
-- PRODUCTS
-- Fix: Cast product_code to text to ensure type match with prod.name
...
-- OPERATORS
-- Fix: Cast operator_id to text to ensure type match with op.name
